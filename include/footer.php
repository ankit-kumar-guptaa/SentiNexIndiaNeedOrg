        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="footer-widget about-widget">
                    <a class="footer-logo"><img src="fine/bglogo.png" alt="Awesome Image"/></a>
                    <p> Near Lalbag Ground Main Road,<br>Indravati Colony, Ward - 8, Lalbag,<br>Amaguda, Jagdalpur (CG) 494001</p>
                    <p>Email: sentinexneedindia@gmail.com</p>
                    <p>Phone: +91 93047 69195</p>
                    ...
                    <ul class="links-list">
                      ...
                      <li>
                         <a href="blog-grid.php">
                            <i class="fa fa-angle-right"></i> Our Blogs
                         </a>
                      </li>
                      <li>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="footer-widget twitter-widget">
                    ...
                    <div class="single-twitter">
                        <p> Release https://t.co/lOelolfR9O <span>http://sentenexneedindia. io/cheats</span></p>
                    </div><!-- /.single-twitter -->
                    <div class="single-twitter">
                        <p> Release https://t.co/lOelolfR9O <span>http://fontawesome. io/cheats</span></p>
                    </div><!-- /.single-twitter -->
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-widget contact-widget">
                    ...
                    <form action="footerForm.php" method="post" class="footer-contact-form">
                        <input type="text" placeholder="Name*" name="name" required />
                        <input type="text" placeholder="Contact No.*" name="contact" required />
                        <input type="text" placeholder="Email*" name="email" required />
                        
                        <button class="thm-btn" name="submit_form" type="submit">Send</button>
                    </form><!-- /.contact-form -->
                </div><!-- /.footer-widget links-widget -->
            </div><!-- /.col-md-3 -->
        </div><!-- /.row -->
...
<div class="footer-bottom text-center">
    <div class="container">
        <p>&copy;  Copyrights 2024. Sentinex Need India Organization All Rights Reserved</p>
    </div><!-- /.container -->
</div><!-- /.footer-bottom -->
